# nvim-treesitter-queries-gaptst

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-gaptst/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-gaptst/actions/workflows/validate.yml)

Neovim tree-sitter queries for **gaptst**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-gaptst",
...
- [ ] Changes are scoped to `gaptst` — do not include files for other languages
